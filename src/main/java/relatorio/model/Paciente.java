...
public class Paciente {
	...
	@Override
	public int hashCode() {
		return Objects.hash(cns, cpf, dataNascimento, email, foneComercial, foneRecado, foneResidencial, idade, mae,
				nomePaciente, pai, prontuario, raca, responsavel, rf, rg, sexo, tipoPaciente);
	}
	@Override
