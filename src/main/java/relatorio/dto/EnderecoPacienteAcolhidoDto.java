...
public class EnderecoPacienteAcolhidoDto {
	public static ArrayList<Endereco> fichaenderecopacientesacolhidos(String dataInicial,String dataFinal) {
		...
		try {
			String sqlString = "SELECT  prontuario, logradouro, nro_logradouro, compl_logradouro, bairro,cidade, uf, cep\r\n"
					...
					+ "WHERE data_acolhimento::date between   '" + dataInicial + "' and  '" + dataFinal + "' GROUP BY prontuario, logradouro, nro_logradouro, compl_logradouro, bairro,cidade, uf, cep" ;
